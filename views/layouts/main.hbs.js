var main = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "</head>\r\n<body>\r\n    <div class=\"wrap\">\r\n";
  stack1 = this.invokePartial(partials['page/nav'], '        ', 'page/nav', depth0, undefined, helpers, partials, data);
  if (stack1 != null) { buffer += stack1; }
  buffer += "\r\n        <div id=\"video-player-box\"></div>\r\n        <div id=\"close-video-box\" class=\"own-hover-glyphicon clear-search-text\">X</div>\r\n\r\n        <section class=\"section-content\">\r\n            <div id=\"main-content-wrapper\" class=\"content-wrapper\">\r\n                ";
